...
export default class ReversiBattle extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  addSelectedBot(event) {
    ...
    BattleActions.addSelectedBot(botName, "reversi");
  };
      ...
      <div className="reversi-battle">
              ...
              <div className="bots-list">
                ...
                <div className="table-container">
                  <table>
                    ...
                    <tbody>
                      {this.props.reversiBots.map(item => {
                      ...
                      <div className="dialog-content">
                        ...
                        <form onSubmit={this.runBattle}>
                          <select name="challengerInfo" className="bot-selecter" value={this.state.challengerInfo} onChange={this.handleChange}>
                            ...
                            {this.props.myReversiBots.map(item => {
          ...
          <div className="my-result">
            ...
            <div className="table-container">
              <table>
                ...
                <tbody>
                  {this.props.myReversiResults.map(item => {
                    let result = item.result.win + "勝" + item.result.lose + "敗" + item.result.draw + "引";
        ...
        <div className="contents-box">
          <div className="reversi-ranking">
            <h2>Reversi Ranking <i className="material-icons info-icon">info_outline</i></h2>
            <div className="table-container">
              <table>
                <thead>
                  <tr>
